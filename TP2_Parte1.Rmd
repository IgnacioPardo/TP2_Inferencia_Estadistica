...
b)  ¿Qué puede decir de la distribución de $\hat\theta_n$ a medida que $n$ aumenta?
    ...
    La distribucion se asemeja a una distribucion normal y a medida que n aumenta, la varianza es mas chica y como consecuencia la campana se afina
...
b\. Se puede observar que a medida que n aumenta, la densidad aumenta alrededor de 3
...
Para cada n elegiriamos el estimador $\tilde\theta_n$ ya que dado a que tiene menor varianza, la densidad se concentra en 3 y por lo tanto el estimador es mas certero
