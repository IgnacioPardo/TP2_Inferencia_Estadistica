...
El estimador $est2$ tiene menor ECME y, como vimos en la teorica, se cumple que $ECM(\hat\sigma^2_n) < ECM(s^2_n) ∀n$
...
El estimador $fest2$ sigue siendo el que menor ECME tiene y se mantiene la relacion que en el item anterior
